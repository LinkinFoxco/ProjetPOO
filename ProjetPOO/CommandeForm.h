...
private: System::Void Modifier_Click(System::Object^ sender, System::EventArgs^ e) {
	this->mode = "maj";
	this->MessageTxT->Text = "Pour confirmer la modification de la quantit� de cet article, appuyez sur le bouton enregister";
}
...
private: System::Void Enregistrer_Click(System::Object^ sender, System::EventArgs^ e) {
	if (this->mode = "ajout")
	{
		...
		this->MessageTxT->Text = "L'ID g�n�r� est le : " + id + ".";
	}
