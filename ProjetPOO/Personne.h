...
public:
	...
	System::String^ SELECTPersonne();
	System::String^ INSERTPersonne();
	System::String^ UPDATEPersonne();
	System::String^ DELETEPersonne();
	System::String^ SELECTPossedePersoLieu();
	System::String^ INSERTPossedePersoLieu();
	System::String^ UPDATEPossedePersoLieu();
	System::String^ DELETEPossedePersoLieu();
};